...
const Register = () => {
    ...
    return (
        <main className="w-full min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-gray-900 dark:to-indigo-950 transition-colors duration-300">
            <motion.div
